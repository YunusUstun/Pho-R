...
await member.roles.remove(inventory.yetkilirolleri.KickRole)
await member.roles.remove(inventory.yetkilirolleri.RozetRole)
await member.roles.remove(inventory.yetkilirolleri.TransporterRole)
}
